...
//原本的中文
Debug.WriteLine(patient_name);
            Debug.WriteLine(patient_name.Length.ToString());
            //原本用PadRight
            Debug.WriteLine(patient_name.PadRight(OnCubeFormatLength.Patient_Name));
            Debug.WriteLine(patient_name.PadRight(OnCubeFormatLength.Patient_Name).Length.ToString());
            //用補byte的方式
            Debug.WriteLine(PadRightToByteLength(patient_name, OnCubeFormatLength.Patient_Name));
            Debug.WriteLine((PadRightToByteLength(patient_name, OnCubeFormatLength.Patient_Name)).Length.ToString());
            //用byte的方式在用PadRight去補
            Debug.WriteLine((PadRightToByteLength(patient_name, 20).PadRight((OnCubeFormatLength.Patient_Name))));
            Debug.WriteLine((PadRightToByteLength(patient_name, 20).PadRight(OnCubeFormatLength.Patient_Name).Length).ToString());


            Debug.WriteLine(PadRightToByteLength(patient_name.PadRight(OnCubeFormatLength.Patient_Name), OnCubeFormatLength.Patient_Name).Length.ToString());
            // Debug.WriteLine(covertToBig5(patient_iD, 8).PadRight(OnCubeFormatLength.Patient_Name));
            // Debug.WriteLine(covertToBig5(patient_iD, 8).PadRight(OnCubeFormatLength.Patient_Name).ToString());
